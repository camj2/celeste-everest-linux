...
```
cd existing_repo
git remote add origin https://gitlab.com/camj/celeste-everest-linux.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/camj/celeste-everest-linux/-/settings/integrations)
